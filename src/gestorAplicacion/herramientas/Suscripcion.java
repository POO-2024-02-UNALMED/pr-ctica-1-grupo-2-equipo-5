...
public enum Suscripcion implements InterfaceTipos{
    ...
    public  String tipos(){
        ...
        String cont = String.format("%30s %30s %30s ","","","EN TODAS LAS FUNCIONES Y ASIENTOS"+"\n\n");
        String tipo3 = String.format("%30s %30s %30s ","VIP",String.format("$%,.2f",18900.0),"25% de Descuento"+"\n");
        String cont2 = String.format("%30s %30s %30s ","","","EN TODAS LAS FUNCIONES Y ASIENTOS"+"\n\n");
        String tipo4 = String.format("%30s %30s %30s ","ELITE",String.format("$%,.2f",39900.0),"FUNCIONES GARTIS\n");
        String cont3 = String.format("%30s %30s %30s ","","","ILIMITADASSSS Y ASIENTO GOLD GRATISSS"+"\n\n");
